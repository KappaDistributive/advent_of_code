...
run_opcode(const Opcode opcode,
  ...
  case Opcode::addr:
    ...
    registers->operator[](c) = registers->operator[](a) + registers->operator[](b);
    break;
  case Opcode::addi:
    // addi (add immediate) stores into register C the result of adding register A and value B.
    registers->operator[](c) = registers->operator[](a) + b;
    break;
  case Opcode::mulr:
